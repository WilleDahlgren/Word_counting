...
The first argument is a textfile with words you don't want to be counted. 
The second argument is the textfile in a form mentioned previously.
The third argument tells the computer to print out the top n most used words. Determines the length of the word tally.
